...
namespace FCG_Games.Api
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                client.BaseAddress = new Uri(builder.Configuration["Services:LibraryApi"]!);
            });
        ...
        "APIM", null);
            ...
            {
                // Aplica migrations
                var relationalDB = scope.ServiceProvider.GetRequiredService<GamesDbContext>();
                relationalDB.Database.Migrate();

                // Cria Index
                var searchDB = scope.ServiceProvider.GetRequiredService<IDatabaseSearch<GameDocument>>();
                searchDB.CreateIndexIfNotExist();
            }
            ...
            app.UseAuthentication(); // IMPORTANTE: Adicionar UseAuthentication
